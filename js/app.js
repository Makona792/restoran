...
let list = document.querySelectorAll('.dish-page__list');
let itembox = document.querySelectorAll('.dish-page__itembox');

for (let i = 0; i < list.length; i++) {
	list[i].addEventListener('click', function () {
		for (let j = 0; j < list.length; j++) {
			list[j].classList.remove('_active');
		}
		...
		for (let k = 0; k < itembox.length; k++) {
			itembox[k].classList.remove('_active');
			itembox[k].classList.add('hide');

			if (itembox[k].getAttribute('data-item') == dataFilter || dataFilter == "all") {
				itembox[k].classList.remove('hide');
				itembox[k].classList.add('_active');
			}
		}
	})
}
...
if (document.querySelector('.main__slider')) {
	let slider_about = new Swiper('.main__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
...
if (document.querySelector('.feature-page__slider')) {
	let slider_about = new Swiper('.feature-page__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.feature-page__arrow_next',
			prevEl: '.feature-page__arrow_prev',
		},
...
if (document.querySelector('.page__stuff')) {
	let slider_about = new Swiper('.stuff-page__slider', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.stuff-page__arrow_next',
			prevEl: '.stuff-page__arrow_prev',
		},
...
if (document.querySelector('.page__customer')) {
	let slider_about = new Swiper('.customer-page__slider', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.customer-page__arrow_next',
			prevEl: '.customer-page__arrow_prev',
		},
		/*
		breakpoints: {
			320: {
...
if (document.querySelector('.page__blog')) {
	let slider_about = new Swiper('.blog-page__slider', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.blog-page__arrow_next',
			prevEl: '.blog-page__arrow_prev',
		},
